...
#          of "KOPF" in each of the n simulations.
...
Diese Funktion soll nun mit n = 10000 aufgerufen und das Ergebnis in der Variablen outcome gespeichert werden. 
```{r}
n_times <- 10000
outcome <- n_repeat_counting_head(n_times)
```

Damit kann ein Schätzwert für die Wahrscheinlichkeit des Ereignisses "Viermal 'KOPF' beim vierfachen Münzwurf berechnet werden. 
```{r}
